<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/AdminUser/Views/Shared/AdminUser.Master" Inherits="System.Web.Mvc.ViewPage<MvcPaging.PagedList<iZINE.Web.MVC.Areas.AdminUser.Models.SheleveModel>>" %>
...
<div class='formBox'>
       ...
       <table width="810px" cellpadding="2" cellspacing="0" class="bATR_Hdr_P">
            ...
            <% foreach (iZINE.Web.MVC.Areas.AdminUser.Models.SheleveModel soi in Model)
            { %>
            <tr>
                <td>
...
<script language="javascript" type="text/javascript">
    ...
    (function($) {
        $(document).ready(function() {            
            ...
            $("#titel").change(function(event) {
                ...
                var callback = function(data, textStatus) {
                    ...
                    $.each(data.items, function(i, val) {
                        ...
                        $("<a>").text("<%=Resources.Resource.edit%>").attr({ href: '/AdminUser/Shelves/editshelveview?sheleveId=' + val.id }).appendTo(vtd);
                        $(vtd).append(" | ");
                ...
                $.post("/AdminUser/shelves/getshelvelist", { Organisation: sel, titel: sel2, page: 1 }, callback, "json");
            ...
            PageClick = function(pageclickednumber) {
                ...
                $.post("/AdminUser/shelves/getshelvelist", { Organisation: sel, titel: sel2, page: pageclickednumber }, callback, "json");
        ...
        $("#popup").dialog(
                {
                    ...
                    overlay: {
                        ...
                        '<%=Resources.Resource.cancel.ToUpper()%>': function() {
                            $(this).dialog('close');
                            var id = $(this).data("id");
                            var url = "/AdminUser/shelves/DeleteLinkHandler/" + id;
    ...
    $(document).ready(function() {
        ...
        var selectOrg = document.getElementById("Organisation");
        ...
        $("#Organisation").change(function() {
            ...
            if (id != '') {
                var url = "/AdminUser/shelves/GetShelves/" + id;

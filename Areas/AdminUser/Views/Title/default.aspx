<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/AdminUser/Views/Shared/AdminUser.Master" Inherits="System.Web.Mvc.ViewPage<MvcPaging.PagedList<iZINE.Web.MVC.Areas.AdminUser.Models.TitleModel>>" %>
...
<div class='formBox'>
    ...
    <%if (Model != null && Model.Count > 0) 
        ...
        <table width="810px" cellpadding="2" cellspacing="0" class="bATR_Hdr_P">
            ...
            <tbody>
            <% foreach (iZINE.Web.MVC.Areas.AdminUser.Models.TitleModel soi in Model)
               { %>
            <tr>
                <td>
...
<script language="javascript" type="text/javascript">
        ...
        $("#popup").dialog(
                {
                    ...
                    overlay: {
                        ...
                        '<%=Resources.Resource.delete.ToUpper()%>': function() {
                            $(this).dialog('close');
                            var id = $(this).data("id");
                            var url = "/AdminUser/title/DeleteLinkHandler/" + id;
    ...
    $(document).ready(function() {
            ...
            if (sel != '') {
                var callback = function(data, textStatus) {
                    ...
                    $.each(data.items, function(i, val) {
                        ...
                        $("<a>").text("<%=Resources.Resource.edit%>").attr({ href: '/AdminUser/title/edittitleview?titleid=' + val.TitleId }).appendTo(vtd);
                        $(vtd).append(" | ");
                ...
                $.post("/AdminUser/title/getjsonlist", { Organisation: sel, page: 1 }, callback, "json");
            }
            else {
                $("#data").html('');
            }
        ...
        PageClick = function(pageclickednumber) {
            ...
            $.post("/AdminUser/title/getjsonlist", { Organisation: sel, page: pageclickednumber }, callback, "json");

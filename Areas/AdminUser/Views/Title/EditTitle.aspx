<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/AdminUser/Views/Shared/AdminUser.Master" Inherits="System.Web.Mvc.ViewPage<iZINE.Businesslayer.Title>" %>
...
<div class='formBox'>
   ...
   <table  width="100%">
        ...
        <tr>
            ...
            <td>
            <%= Html.DropDownList("Organisation", null, "["+Resources.Resource.selectOrganisation+"]", new { @id = "Organisation", style = "width:204px" })%>
                                                ...
                                                <li>
                                                 ...
                                                 <%foreach(iZINE.Web.MVC.Models.StatusModel statusLayout in (List<iZINE.Web.MVC.Models.StatusModel>)ViewData["status"])
                                                    { %>
                                                        ...
                                                        <%foreach (iZINE.Web.MVC.Areas.AdminUser.Models.TitleStatusModel titleStatus in (List<iZINE.Web.MVC.Areas.AdminUser.Models.TitleStatusModel>)ViewData["statusByTitle"])
                                                          {                                                                                                                     

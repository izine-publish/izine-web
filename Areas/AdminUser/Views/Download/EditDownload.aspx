<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/AdminUser/Views/Shared/AdminUser.Master" Inherits="System.Web.Mvc.ViewPage<iZINE.Businesslayer.Download>" %>
...
<div class='formBox'>
  ...
  <% using (Html.BeginForm("editdownload", "Download", new
   {
    ...
    <%} %>  
  <% using (Html.BeginForm("canceldownload", "Download", new
   {
       controller = "Download",
     ...
     (function($) {
         $(document).ready(function() {
             $("#cancelBtn").click(function() {
                 //        $("#form2").submit();
             $.post("/AdminUser/Download/canceldownload");
             });
         });

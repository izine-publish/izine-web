<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/AdminUser/Views/Shared/AdminUser.Master" Inherits="System.Web.Mvc.ViewPage<MvcPaging.PagedList<iZINE.Web.MVC.Areas.AdminUser.Models.DownloadModal>>" %>
...
<div class='formBox'>
      ...
      <table width="810px" cellpadding="2" cellspacing="0" class="bATR_Hdr_P">
            ...
            <tbody>
             <%foreach(iZINE.Web.MVC.Areas.AdminUser.Models.DownloadModal don in Model) %>
             <%{ %>
                <tr>
                <td>
...
<% using (Html.BeginForm("create", "Download", null, FormMethod.Post, new { id = "EditForm" })) { } %>       
        ...
        $("#popup").dialog(
                {
                    ...
                    '<%=Resources.Resource.delete.ToUpper()%>': function() {
                            $(this).dialog('close');
                            var id = $(this).data("id");
                            var url = "/AdminUser/Download/DeleteLinkHandler/" + id;

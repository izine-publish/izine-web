<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/AdminUser/Views/Shared/AdminUser.Master" Inherits="System.Web.Mvc.ViewPage<iZINE.Businesslayer.User>" %>
...
<div class='formBox'>
    <div class='formBoxHeader'>
     ...
     <div class='formBoxBody'>
        ...
        <% using (Html.BeginForm(new { userId = Model.UserId, controller = "users", action = "EditUser" }))
          {%>
            <div id="tabs">
	            <ul>
	                ...
	                <%if (Model != null)
                   {%>
                       <%foreach( iZINE.Web.MVC.Areas.AdminUser.Models.TitleModel tille in (List<iZINE.Web.MVC.Areas.AdminUser.Models.TitleModel>)ViewData["Titles"])
                         {%>

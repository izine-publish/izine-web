<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/AdminUser/Views/Shared/AdminUser.Master" Inherits="System.Web.Mvc.ViewPage<MvcPaging.PagedList<iZINE.Web.MVC.Areas.AdminUser.Models.OrganisationModel>>" %>
            ...
            {%> 
                <table width="810px" cellpadding="2" cellspacing="0" class="bATR_Hdr_P">
                    ...
                    <tbody>
                        ...
                        <% foreach (iZINE.Web.MVC.Areas.AdminUser.Models.OrganisationModel soi in Model)
                        { %>
                            <tr>
                                 <td>
...
<% using (Html.BeginForm("editorganisationview", "Organization", new { orgname = "", page = 1 }, FormMethod.Post, new { id = "EditForm" })) { } %>
        ...
        $("#popup").dialog(
                {
                    ...
                    overlay: {
                        ...
                        '<%=Resources.Resource.delete.ToUpper()%>': function() {
                            $(this).dialog('close');
                            var id = $(this).data("id");
                            var url = "/AdminUser/Organization/DeleteLinkHandler/" + id;
        ...
        PageClick = function(pageclickednumber) {
            ...
            var callback = function(data, textStatus) {
                ...
                $.each(data.items, function(i, val) {
                    ...
                    $("<a>").text("<%=Resources.Resource.edit%>").attr({ href: '/AdminUser/Organization/editorganisationview?orgid=' + val.OrganisationId }).appendTo(vtd);
                    $(vtd).append(" | ");
            ...
            $.post("/AdminUser/Organization/JsonIndex", { page: pageclickednumber }, callback, "json");

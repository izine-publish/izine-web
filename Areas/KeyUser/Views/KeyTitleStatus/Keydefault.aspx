<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/KeyUser/Views/Shared/KeyUser.Master" Inherits="System.Web.Mvc.ViewPage<MvcPaging.PagedList<iZINE.Web.MVC.Areas.KeyUser.Models.TitleStatusModel>>" %>
...
<div class='formBox'>
        ...
        <div class='formBoxBody'>
            ...
            {%> 
                <table width="810px" cellpadding="2" cellspacing="0" class="bATR_Hdr_P">
                    ...
                    <tbody>
                        ...
                        <% foreach (iZINE.Web.MVC.Areas.KeyUser.Models.TitleStatusModel soi in Model)
                        { %>
                            <tr>
                                 <td>
         ...
         <% using (Html.BeginForm("editstatusview", "Keytitlestatus", new { name = "", page = 1 }, FormMethod.Post, new { id = "EditForm" })) { } %>
        ...
        $("#popup").dialog(
                {
                    ...
                    overlay: {
                        ...
                        '<%=Resources.Resource.delete.ToUpper()%>': function() {
                            $(this).dialog('close');
                            var id = $(this).data("id");
                            var url = "/KeyUser/KeyTitleStatus/DeleteLinkHandler/" + id; 
        ...
        PageClick = function(pageclickednumber) {
            ...
            var callback = function(data, textStatus) {
                ...
                $.each(data.items, function(i, val) {
                    ...
                    $("<a>").text("<%=Resources.Resource.edit%>").attr({ href: '/KeyUser/KeyTitleStatus/editstatusview?statusid=' + val.statusid }).appendTo(vtd);
                    $(vtd).append(" | ");
            ...
            $.post("KeyUser/KeyTitleStatus/JsonIndex", { page: pageclickednumber }, callback, "json");
        }
    });

<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/KeyUser/Views/Shared/KeyUser.Master" Inherits="System.Web.Mvc.ViewPage<iZINE.Businesslayer.Title>" %>
...
<div class='formBox'>
    ...
    <div class='formBoxHeader'>
     ...
     <div class='formBoxBody'>
       ...
       <% using (Html.BeginForm("edittitle", "KeyTitle", new
   {
   ...
   <table  width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:Panel ID="Panel1"  runat="server" Height="120px" Width="95%" BorderWidth="1pt" BorderColor="Black" BorderStyle="Solid" ScrollBars="Vertical">&nbsp;&nbsp;
    ...
    &nbsp
    <input type="submit" name="SaveButton" value="<%=Resources.Resource.save.ToUpper()%>" id="Submit1" class="defaultButton" onmouseover="this.className='defaultButtonOver';" onmouseout="this.className='defaultButton';" />
    <button name="button" value="<%=Resources.Resource.cancel.ToUpper()%>" id="Button2" class="defaultButton" onmouseover="this.className='defaultButtonOver';" onmouseout="this.className='defaultButton';" ><%=Resources.Resource.cancel.ToUpper()%></button>

<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/KeyUser/Views/Shared/KeyUser.Master" Inherits="System.Web.Mvc.ViewPage<iZINE.Businesslayer.Shelve>" %>
...
<div class='formBox'>
   ...
   <% using (Html.BeginForm("editshelve", "Keyshelves", new
   {
       controller = "Keyshelves",
       action = "editshelve",
       sheleveId = Model.ShelveId

<%--
//---------------------------------------------------------------------------------------------------------------
//    $HeadURL: https://my.redfive.biz/svn/izine/iZINE.Web/trunk/iZINE.Web.MVC/Views/shelves/default.aspx $
...
//    Description: View for Shelves

//   Copyright: 2010 iZine Solutions. All rights reserved.
//---------------------------------------------------------------------------------------------------------------
--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdminSite.Master" Inherits="System.Web.Mvc.ViewPage<MvcPaging.PagedList<iZINE.Web.MVC.Models.SheleveModel>>" %>
...
<div class='formBox'>
        ...
        <div class='formBoxBody'>
          ...
          <% using (Html.BeginForm())
             ...
             <td>
             <%= Html.DropDownList("Organisation", "[selecteer een organisatie]")%>
             </td>
             <td>
       ...
       <table width="810px" cellpadding="2" cellspacing="0" class="bATR_Hdr_P">
            ...
            <% foreach (iZINE.Web.MVC.Models.SheleveModel soi in Model)
            { %>
            <tr>
                <td>
                ...
                <%=Html.ActionLink(Resources.Resource.edit, "editshelveview", new { sheleveid = soi.SheleveId,
                                                           controller = "shelves",action = "editshelveview" })%> <label>|</label> <a id="deleteItem" href="javascript: void(0);"><%=Resources.Resource.delete%></a>
...
<% using (Html.BeginForm("create", "shelves", new
           {
    ...
    (function($) {
        $(document).ready(function() {
            ...
            $("#titel").change(function(event) {
                ...
                var callback = function(data, textStatus) {
                    ...
                    $.each(data.items, function(i, val) {
                        ...
                        $("<a>").text("<%=Resources.Resource.edit%>").attr({ href: '/shelves/editshelveview?sheleveId=' + val.id }).appendTo(vtd);
                        $(vtd).append(" | ");
                ...
                $.post("/shelves/getshelvelist", { Organisation: sel, titel: sel2, page: 1 }, callback, "json");
            ...
            PageClick = function(pageclickednumber) {
                ...
                $.post("/shelves/getshelvelist", { Organisation: sel, titel: sel2, page: pageclickednumber }, callback, "json");
        ...
        $("#popup").dialog(
                {
                    ...
                    overlay: {
                        ...
                        '<%=Resources.Resource.cancel.ToUpper()%>': function() {
                            $(this).dialog('close');
                            var id = $(this).data("id");
                            var url = "/shelves/DeleteLinkHandler/" + id;

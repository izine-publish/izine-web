<%--
//---------------------------------------------------------------------------------------------------------------
//    $HeadURL: https://my.redfive.biz/svn/izine/iZINE.Web/trunk/iZINE.Web.MVC/Views/AdminDownload/Default.aspx $
...
//    Description: View for admin download

//   Copyright: 2010 iZine Solutions. All rights reserved.
//---------------------------------------------------------------------------------------------------------------
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdminSite.Master" Inherits="System.Web.Mvc.ViewPage<MvcPaging.PagedList<iZINE.Web.MVC.Models.DownloadModal>>" %>
...
<% using (Html.BeginForm("create", "admindownload", null, FormMethod.Post, new { id = "EditForm" })) { } %>       
        ...
        $("#popup").dialog(
                {
                    ...
                    '<%=Resources.Resource.delete.ToUpper()%>': function() {
                            $(this).dialog('close');
                            var id = $(this).data("id");
                            var url = "/AdminDownload/DeleteLinkHandler/" + id;

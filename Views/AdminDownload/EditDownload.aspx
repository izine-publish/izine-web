<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdminSite.Master" Inherits="System.Web.Mvc.ViewPage<iZINE.Businesslayer.Download>" %>
...
<div class='formBox'>
  ...
  <% using (Html.BeginForm("editdownload", "admindownload", new
   {
    ...
    <%} %>  
  <% using (Html.BeginForm("canceldownload", "admindownload", new
   {
       controller = "admindownload",

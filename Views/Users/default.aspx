<%--
//---------------------------------------------------------------------------------------------------------------
//    $HeadURL: https://my.redfive.biz/svn/izine/iZINE.Web/trunk/iZINE.Web.MVC/Views/Users/default.aspx $
...
//---------------------------------------------------------------------------------------------------------------
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdminSite.Master" Inherits="System.Web.Mvc.ViewPage<MvcPaging.PagedList<iZINE.Web.MVC.Models.UserModel>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <%if (Model != null && Model.Count > 0) 
        ...
        <table width="810px" cellpadding="2" cellspacing="0" class="bATR_Hdr_P" style="margin-top:10px">
            ...
            <tbody>
            <% foreach (iZINE.Web.MVC.Models.UserModel soi in Model)
               { %>
            <tr>
                <td>
...
<script language="javascript" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#Organisation").change(function(event) {
            ...
            '</thead>');
                ...
                /////////////////////////////////////////////////////////////////////
                    ...
                    $("<a>").text("<%=Resources.Resource.edit%>").attr({ href: '/users/edituserview?userid=' + val.UserId }).appendTo(vtd);
                    $(vtd).append(" | ");
            ...
            $.post("/users/getjsonlist", { Organisation: sel, page: 1 }, callback, "json");
        ...
        $.post("/users/getjsonlist", { Organisation: sel, page: pageclickednumber }, callback, "json");

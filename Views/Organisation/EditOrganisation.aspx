<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdminSite.Master" Inherits="System.Web.Mvc.ViewPage<iZINE.Businesslayer.Organization>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class='formBox'>
        ...
        <div class='formBoxBody'>
           ...
           <% using (Html.BeginForm("editorganisation", "organisation", new
   {

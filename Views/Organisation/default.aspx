<%--
//---------------------------------------------------------------------------------------------------------------
//    $HeadURL: https://my.redfive.biz/svn/izine/iZINE.Web/trunk/iZINE.Web.MVC/Views/Organisation/default.aspx $
...
//    Description: View for organisation

//   Copyright: 2010 iZine Solutions. All rights reserved.
//---------------------------------------------------------------------------------------------------------------
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdminSite.Master" Inherits="System.Web.Mvc.ViewPage<MvcPaging.PagedList<iZINE.Web.MVC.Models.OrganisationModel>>" %>
            ...
            {%> 
                <table width="810px" cellpadding="2" cellspacing="0" class="bATR_Hdr_P">
                    ...
                    <tbody>
                        ...
                        <% foreach (iZINE.Web.MVC.Models.OrganisationModel soi in Model)
                        { %>
                            <tr>
                                 <td>
